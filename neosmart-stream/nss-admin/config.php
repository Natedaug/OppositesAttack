	...
	<form class="nss-admin-form" method="post">
		...
		<!--div class='row'>
			...
			<div class="field-area">
				...
				<div class="field-info">Set locale information via PHP <a href="http://php.net/manual/en/function.setlocale.php" target="_blank">setlocale</a>.<br /><b>Default: en_US</b></div>
			</div>
		</div-->
		<div class='row'>
			<label>Default timezone</label>
			<div class="field-area">
				<input name='date_default_timezone' type='text' placeholder="<?php echo date_default_timezone_get(); ?>" class='text' value='<?php echo $nss->get('date_default_timezone'); ?>'>
				<div class="field-info">Overrides default timezone via PHP <a href="http://php.net/manual/en/function.date-default-timezone-set.php" target="_blank">date_default_timezone_set</a><br /><b>Default Timezone: <?php echo date_default_timezone_get(); ?></b></div>
			</div>
		</div>
		<div class='row hl'>
		...
		<div class='row'>
			...
			<div class="field-area">
				...
				<div class="field-info"><a href="https://dev.twitter.com/apps/new" target="_blank">Create a Twitter app</a> and enter your API key.</div>
			</div>
		</div>
		<div class='row'>
			...
			<div class="field-area">
				...
				<div class="field-info"><a href="https://dev.twitter.com/apps/new" target="_blank">Create a Twitter app</a> and enter your API secret.</div>
			</div>
		</div>
